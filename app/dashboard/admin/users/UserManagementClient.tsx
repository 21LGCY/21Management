    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-dark-card via-dark-card to-primary/5 border border-gray-800 rounded-xl p-6 shadow-xl">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-white">{tCommon('search')} & {tCommon('filter')}</h3>
        </div>
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <CustomSelect
            ...
            options={[
              { value: 'all', label: tRoles('admin') + '/' + tRoles('manager') + '/' + tRoles('player') },
        ...
        {filteredUsers.length > 0 ? (
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex-shrink-0">
                      {user.role === 'admin' ? (
                        ...
                        >
                          {teamTag || tCommon('noTeam')} | {getUserRoleLabel(user.role)}
                        </span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {user.role === 'manager' && user.staff_role && (
                      <div className="p-3 bg-dark/50 rounded-lg border border-gray-800">
                        <p className="text-gray-400 text-xs mb-1.5 font-medium">{t('staffRole')}</p>
          ...
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-gray-400 text-lg mb-2">
              {users.length === 0 ? t('noUsers') : tCommon('noResults')}
            </p>
