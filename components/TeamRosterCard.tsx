    ...
    <div className="bg-gradient-to-br from-dark-card to-dark border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-400">{teamName} - {players.length} players</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="bg-gradient-to-br from-green-500/10 to-dark border border-green-500/30 rounded-lg p-3 text-center">
          ...
          <p className="text-xs text-green-300/70">Main Roster</p>
        </div>
        <div className="bg-gradient-to-br from-orange-500/10 to-dark border border-orange-500/30 rounded-lg p-3 text-center">
          ...
          <p className="text-xs text-orange-300/70">Substitutes</p>
        </div>
        <div className="bg-gradient-to-br from-yellow-500/10 to-dark border border-yellow-500/30 rounded-lg p-3 text-center">
          ...
          <p className="text-xs text-yellow-300/70">IGL{players.filter(p => p.is_igl).length !== 1 ? 's' : ''}</p>
        </div>
      </div>
      ...
      {mainRoster.length > 0 && (
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-white">Main Roster</h3>
      ...
      {substitutes.length > 0 && (
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-white">Substitutes</h3>
      ...
      {players.length === 0 && (
        <div className="text-center py-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Contact your manager for more information</p>
        </div>
      )}
    </div>
  )
